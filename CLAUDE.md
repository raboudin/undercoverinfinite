...
- `api/` — NestJS backend with Prisma ORM. Three domain modules: `entitlements` (packs, modes, thèmes, crédits), `words` (le tirage des mots par LLM) et `auth` (comptes, profil, JWT en cookies, OAuth Google/Facebook) — see below.
